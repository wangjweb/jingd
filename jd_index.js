...
var adv={
	...
	ulIdxs:null,//广告序号的ul
	init:function(){var self=this;//留住this
...
for(var i=0,idxs=[];i<imgs.length;idxs[i]=i++ +1);
	...
	updateView:function(){var self=this;//留住this
	...
	//将ul移动n个位置
	move:function(n){var self=this;//留住this
		//先停止正在播放的动画
	...
	moveStep:function(n){var self=this;//留住this
